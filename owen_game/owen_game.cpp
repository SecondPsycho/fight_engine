...
int main(int argc, char* argv[]){
    ...
    //Create Sprite Data
    idle.addAnimationData(make_sprite("./assets/wolf_idle.png"));
    walk.addAnimationData(make_sprite("./assets/wolf_walk/wolf_walk1.png"));
    walk.addAnimationData(make_sprite("./assets/wolf_walk/wolf_walk2.png"));
    leap.addAnimationData(make_sprite("./assets/wolf_leap.png"));
